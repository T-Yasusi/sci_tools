import { ComplexMatrix, Matrix } from '../classes.js'
import { abs } from '../functions.js'
import { sub } from '../operators.js'
import isSymmetric from './isSymmetric.js'

export default function isHermite(mat: Matrix | ComplexMatrix, eps: number = 1.0e-8 ): boolean {
    if( mat.cols !== mat.rows ) return false;
    if( mat instanceof Matrix ) return isSymmetric(mat, eps);
    let flag = true;
