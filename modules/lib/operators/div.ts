...
function div(a: Divisible, b: Divisible): any {
    ...
    if (typeof b === 'bigint' && b === 0n ) throw new Error('Division by zero');
    
    if (typeof a === 'number' && typeof b === 'number') return a / b;
    if (typeof a === 'bigint' && typeof b === 'bigint') {
	if (a % b !== 0n) throw new Error('BigInt division must be exact');
	return a / b;
    }
    
    if (typeof a === 'string' || typeof b === 'string') throw new Error('Division not supported for strings');

    if (typeof a === 'object' && a !== null && typeof a.div === 'function') return a.div(b);
